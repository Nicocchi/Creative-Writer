...
export function createNewCharacterInfo(char) {
    return (dispatch, getState) => {
        ...
        console.log("ADDING CHARACTER INFO => ", project);

        dispatch({ type: ADD_CHARACTER_INFO_SUCCESS, payload: {project: project, char: char, info: project.project.characters[char].info.length - 1} });
